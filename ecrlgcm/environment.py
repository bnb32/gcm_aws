...
os.environ['ISCA_TOPO_DIR'] = ISCA_TOPO_DIR = f'{USER_DIR}/inputdata/topo_files/isca'
...
os.environ['CESM_TOPO_DIR'] = CESM_TOPO_DIR = f'{USER_DIR}/inputdata/topo_files/cesm'
