...
with open(os.path.join(here, "ecrlgcm", "version.py"), encoding="utf-8") as f:
    version = f.read()
...
setup(
    name="ecrlgcm",
    version=version,
    description="Tools for building and running different gcms on aws",
    long_description=readme,
    author="Brandon Benton",
    url="https://github.com/bnb32/gcm_aws.git",
